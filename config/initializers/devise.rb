...
Devise.setup do |config|
  ...
  config.saml_configure do |settings|
    settings.assertion_consumer_service_url     = "http://localhost:8080/factors"
    settings.assertion_consumer_service_binding = "urn:oasis:names:tc:SAML:2.0:bindings:HTTP-POST"
    settings.name_identifier_format             = "urn:oasis:names:tc:SAML:2.0:nameid-format:transient"
    settings.issuer                             = "https://app.onelogin.com/saml/metadata/462924"
    settings.authn_context                      = "urn:oasis:names:tc:SAML:2.0:ac:classes:PasswordProtectedTransport"
    settings.idp_slo_target_url                 = "https://marmar-is.onelogin.com/trust/saml2/http-redirect/slo/462924"#{ENV['ONE_LOGIN_APP_ID']}"
    settings.idp_sso_target_url                 = "https://marmar-is.onelogin.com/trust/saml2/http-post/sso/462924"#{ENV['ONE_LOGIN_APP_ID']}"
  ...
  config.secret_key = 'e9aa225aef6da05d3531b527b54af93f7f7f3bfb2df119c94281413e027d8d7716fa7478f45648120cd15d78c0ddc2ad3b92c339447e5a01fdd990b51f5f8677'

  # ==> Mailer Configuration
  # Configure the e-mail address which will be shown in Devise::Mailer,
  # note that it will be overwritten if you use your own mailer class
  # with default "from" parameter.
  config.mailer_sender = 'no-reply@thorsongroup.com'
  ...
  # config.pepper = '8fd4e323a5a806161901538d23bc6ac20c0f3969d90900680da96d911dd4694560be04aee1c259c750f36c75b13bf2e562f229bf263138e0f893c8afaacb54bb'
