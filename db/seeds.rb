...
RiskFactor.create!(min_factor: 0.95, max_factor: 1.05, criteria: "Claims Free 3 to 5 Years")
RiskFactor.create!(min_factor: 0.95, max_factor: 1.05, criteria: "Claims Free 5 Years +")
...
RiskFactor.create!(min_factor: 0.95, max_factor: 1.05, criteria: "Record Keeping Practices")
RiskFactor.create!(min_factor: 0.95, max_factor: 1.05, criteria: "Cooperation with Underwriting & Claims Departments")
RiskFactor.create!(min_factor: 0.95, max_factor: 1.05, criteria: "Group Loss Experience (Not Otherwise Recognized)")
